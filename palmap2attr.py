...
palette_map_names = glob.glob('color/tilesets/*.asm')
...
#		.replace('_palette_map.asm', '_metatiles.bst'))
#	attributes_name = metatiles_name.replace('_metatiles', '_attributes')
	palette_map_name = palette_map_name.replace('\\', '/')
	metatiles_name = (palette_map_name.replace('color/tilesets/', 'gfx/blocksets/')
		.replace('.asm', '.bst'))
	attributes_name = metatiles_name.replace('.bst', '_attr.bst')
