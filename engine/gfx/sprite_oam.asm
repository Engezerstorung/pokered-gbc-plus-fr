...
;	pop hl
	...
	ld a, [de] ; reload the value from DE to remove the value we added
	and $f0
	dec h
	ld [hli], a ; [x#SPRITESTATEDATA1_XADJUSTED]
...
SpriteTileVRAMOffset:
	...
	db $8 * 12
	db $9 * 12
	db $a * 12      ; Sprites $a and $b have one face (and therefore 4 tiles instead of 12).
	db $a * 12 + 4  ; As a result, sprite $b's tile offset is less than normal.
