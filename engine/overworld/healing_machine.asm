...
PokeCenterOAMData:
	...
	dbsprite  6,  4,  4,  4, $fe, OAM_PAL1 | 7
	; poke balls 1-6
	dbsprite  6,  5,  0,  3, $ff, OAM_PAL1 | 7
	dbsprite  7,  5,  0,  3, $ff, OAM_PAL1 | OAM_HFLIP | 7
	dbsprite  6,  6,  0,  0, $ff, OAM_PAL1 | 7
	dbsprite  7,  6,  0,  0, $ff, OAM_PAL1 | OAM_HFLIP | 7
	dbsprite  6,  6,  0,  5, $ff, OAM_PAL1 | 7
	dbsprite  7,  6,  0,  5, $ff, OAM_PAL1 | OAM_HFLIP | 7
