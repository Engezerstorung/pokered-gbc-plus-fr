...
; spritestatedata2 struct members (see macros/ram.asm)
	...
	const SPRITESTATEDATA2_FACINGTABLE          ; 1
	...
	const SPRITESTATEDATA2_YPIXELOFFSET         ; a
	const SPRITESTATEDATA2_XPIXELOFFSET         ; b
	const SPRITESTATEDATA2_ANIMATION            ; c
	const SPRITESTATEDATA2_PALETTEID            ; d
	const SPRITESTATEDATA2_IMAGEBASEOFFSET      ; e
	const SPRITESTATEDATA2_REFLECTION           ; f
