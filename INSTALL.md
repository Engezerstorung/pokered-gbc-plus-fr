...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 1.0.0 globally. Instead, you can put its files in a directory within pokered, such as `pokered-gbc/rgbds-1.0.0/`. Then specify it when you run `make`:
