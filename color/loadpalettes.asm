...
LoadTilesetPalette:
	...
	xor a
	ldh [rWBK], a
	ld a, [wCurMap] ; Located in wram bank 1
	ld b, a
	...
	ld de, W2_BgPaletteData ; palette data to be copied to wram at de
	ld b, $08
.nextPalette
	ld c, $08
...
;	cp 1
	...
	ld a, [hli] ; # hl de is the palette index for MapPalettes
...
.nextColor
	...
	; retrieve wCurMap and wCurMapTileset
	pop bc
