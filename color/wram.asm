...
DEF W2_LastBGP2    EQU $d085
DEF W2_UseBGP2     EQU $d086
DEF W2_LastBGPText EQU $d087

DEF W2_PalSlotTemp EQU $d088

DEF W2_BGPMap EQU $d100
...
DEF W2_OverworldTileMapBackup       EQU $dd0F ; 360 bytes
DEF W2_OverworldTileMapPalMapBackup EQU $de77 ; 360 bytes
...
DEF w3FloorReflectionDistance  EQU $d000 ; 16 bytes, one per map object
DEF w3MirrorReflectionDistance EQU $d010 ; 16 bytes, one per map object