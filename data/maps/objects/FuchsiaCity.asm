...
FuchsiaCity_Object:
	...
	warp_event 19, 35, ROUTE_19_GATE, 1
	warp_event 20, 35, ROUTE_19_GATE, 1
	...
	object_event 25,  6, SPRITE_VOLTORB, STAY, ANY_DIR, TEXT_FUCHSIACITY_VOLTORB
	...
	object_event  8, 17, SPRITE_SWIMMER, WALK, ANY_DIR, TEXT_FUCHSIACITY_LAPRAS        ; Secretly Lapras
	object_event  6,  5, SPRITE_COOLTRAINER_M, STAY, ANY_DIR, TEXT_FUCHSIACITY_FOSSIL  ; Secretly Fossil
