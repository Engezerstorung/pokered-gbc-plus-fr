...
BillsHouse_Object:
	...
	object_event  0,  0, SPRITE_BILLS_MACHINE, STAY, LEFT, 0
	object_event  1,  0, SPRITE_BILLS_MACHINE, STAY, DOWN, 0
	object_event  2,  0, SPRITE_BILLS_MACHINE, STAY, RIGHT, 0
	object_event  5,  0, SPRITE_BILLS_MACHINE, STAY, LEFT, 0
	object_event  6,  0, SPRITE_BILLS_MACHINE, STAY, DOWN, 0
	object_event  7,  0, SPRITE_BILLS_MACHINE, STAY, RIGHT, 0
