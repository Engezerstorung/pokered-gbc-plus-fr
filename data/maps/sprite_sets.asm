...
MapSpriteSets:
	...
	db SPRITESET_ROUTE_18_19     ; ROUTE_19
...
SplitMapSpriteSets:
	...
	db EAST_WEST,   34, SPRITESET_CYCLING_ROAD,    SPRITESET_ROUTE_18_19     ; SPLITSET_ROUTE_18
	db EAST_WEST,   53, SPRITESET_PALLET_VIRIDIAN, SPRITESET_ROUTE_18_19     ; SPLITSET_ROUTE_20
...
; SPRITESET_CELADON
	db SPRITE_LITTLE_GIRL
	db SPRITE_SNORLAXBIG ; SPRITE_LITTLE_BOY
	db SPRITE_GIRL
	db SPRITE_FISHER
...
; SPRITESET_SILENCE_BRIDGE
	...
	db SPRITE_FISHER
	db SPRITE_ROCKER
	db SPRITE_SNORLAXBIG ; SPRITE_MONSTER
	db SPRITE_POKE_BALL
	db SPRITE_SNORLAX
...
; SPRITESET_CYCLING_ROAD
	...
	db SPRITE_HIKER
	db SPRITE_GAMBLER
	db SPRITE_SNORLAXBIG ; SPRITE_MIDDLE_AGED_MAN
	db SPRITE_SUPER_NERD
	db SPRITE_POKE_BALL
	db SPRITE_SNORLAX

; SPRITESET_ROUTE_18_19
